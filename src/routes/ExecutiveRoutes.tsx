...
import { ExecutiveOrdersAllPage } from "../pages/executive/ExecutiveOrdersAllPage";
import { ExecutiveQueriesAllPage } from "../pages/executive/ExecutiveQueriesAllPage";
...
export const executiveNestedRoutes = [
  ...
  <Route key="exec-queries-all" path="queries/all" element={<ExecutiveQueriesAllPage />} />,
  ...
  <Route key="exec-orders-all" path="orders/all" element={<ExecutiveOrdersAllPage />} />,
